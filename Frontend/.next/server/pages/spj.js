...
function Spj({ data , ck , dept  }) {
    ...
    const download = (id)=>{
        fetch("http://localhost:3001/api/" + `home/spj/download/` + id, {
            method: "GET",
            headers: {
...
async function getServerSideProps(context) {
    ...
    // fetch data
    const resp = await fetch("http://localhost:3001/api/" + `home/spj/` + params, {
        method: "GET",
        headers: {
            Authorization: `Bearer ${ck.token}`,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Spj);
...
var __webpack_exports__ = __webpack_require__.X(0, [676,664,10], () => (__webpack_exec__(139)));
