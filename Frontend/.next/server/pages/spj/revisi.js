...
const ck = new (universal_cookie__WEBPACK_IMPORTED_MODULE_5___default())();
function UploadFile({ tkn , dept  }) {
    ...
    const send = async (e)=>{
        ...
        const resp = await fetch("http://localhost:3001/api/" + `home/spj/check/` + id, {
            method: "POST",
            headers: {
...
var __webpack_exports__ = __webpack_require__.X(0, [676,664,10], () => (__webpack_exec__(7149)));
