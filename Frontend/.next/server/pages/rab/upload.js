...
function UploadFile({ tkn , dept  }) {
    const send = async (e)=>{
        ...
        const resp = await fetch("http://localhost:3001/api/" + `home/rab/add`, {
            method: "POST",
            headers: {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_4___default()), {
                                        ...
                                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                                            classame: "bg-white hover:bg-white hover:bg-grey-600 active:bg-grey-700 focus:outline-none focus:ring py-2 rounded-lg px-6 py-2",
                                            children: "Cancel"
                                        })
                                    })
                                ]
...
var __webpack_exports__ = __webpack_require__.X(0, [676,664,10], () => (__webpack_exec__(7618)));
