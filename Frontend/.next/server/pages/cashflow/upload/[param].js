...
function UploadFile({ dept  }) {
    ...
    const send = async (e)=>{
        ...
        const resp = await fetch("http://localhost:3001/api/" + `home/record/add`, {
            method: "POST",
            headers: {
...
async function getServerSideProps(context) {
    ...
    const ck = cookie__WEBPACK_IMPORTED_MODULE_6__.parse(context.req.headers.cookie);
...
var __webpack_exports__ = __webpack_require__.X(0, [676,664,10], () => (__webpack_exec__(9336)));
